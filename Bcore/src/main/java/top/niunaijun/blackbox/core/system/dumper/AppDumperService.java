...
public class AppDumperService implements ISystemService {
    ...
    public boolean dumpIL2CPP(String packageName, String outputDir) {
        ...
        try {
            ...
            generateStringDump(packageName, output, ai);
    ...
    private void generateStringDump(String pkg, File output, ApplicationInfo ai) {
        try {
            StringBuilder sb = new StringBuilder();
            ...
            sb.append("  package: ").append(pkg).append("\n");
            sb.append("  version: ").append(ai.versionName != null ? ai.versionName : "unknown").append("\n");
            sb.append("\n[Common Strings]\n");
            String[] strings = {
